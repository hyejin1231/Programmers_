...
public final class Base64Coder
{
    ...
    public static String encodeLines(byte[] paramArrayOfByte, int paramInt1,
            int paramInt2, int paramInt3, String paramString)
    {
        ...
        while (m < paramInt2)
        {
            ...
            localStringBuilder
                    .append(encode(paramArrayOfByte, paramInt1 + m, n));
    ...
    public static char[] encode(byte[] paramArrayOfByte, int paramInt1,
            int paramInt2)
    {
    ...
    public static byte[] decode(char[] paramArrayOfChar, int paramInt1,
            int paramInt2)
    {
        
        int param2 = paramInt2;
        if (param2 % 4 != 0) { throw new IllegalArgumentException(
                "Length of Base64 encoded input string is not a multiple of 4."); }
        while ((param2 > 0)
                && (paramArrayOfChar[(paramInt1 + param2 - 1)] == '='))
        {
            param2--;
        }
        int i = param2 * 3 / 4;
        ...
        while (j < k)
        {
            ...
            if ((n > 127) || (i1 > 127) || (i2 > 127) || (i3 > 127)) { throw new IllegalArgumentException(
                    "Illegal character in Base64 encoded data."); }
            int i4 = map2[n];
            int i5 = map2[i1];
            int i6 = map2[i2];
            int i7 = map2[i3];
            if ((i4 < 0) || (i5 < 0) || (i6 < 0) || (i7 < 0)) { throw new IllegalArgumentException(
                    "Illegal character in Base64 encoded data."); }
            int i8 = i4 << 2 | i5 >>> 4;
